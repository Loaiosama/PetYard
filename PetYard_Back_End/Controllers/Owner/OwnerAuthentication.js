...
const updateInfo = async (req, res) => {
    ...
    try {
        ...
        const updateQuery = 'UPDATE Petowner SET First_name = $1, Last_name = $2, Email = $3, Phone = $4, Date_of_birth = $5 ,Image=$6 WHERE Owner_Id = $7';
        await pool.query(updateQuery, [firstName, lastName, email, phoneNumber, dateOfBirth, Image, owner_id]);
