...
class ProviderChatScreenState extends State<ProviderChatScreen> {
  ...
  void initState() {
    ...
    context
        ...
        .getChatHistory(widget.senderId, widget.receiverId);
  }
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      if (index < state.chats.length) {
                        ...
                        final isMe =
                            message.data?[0].senderId == widget.senderId &&
                                message.data?[0].role == widget.role;
                        return message.data?[0].message == ''
                            ? const SizedBox()
                            : Align(
                                alignment:
                                    message.data?[0].message == 'session start'
                                        ? Alignment.center
                                        : (isMe
